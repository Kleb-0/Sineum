export default function Post() {
  return (
    <div className="flex items-center max-h-screen max-w-screen flex-col gap-4 sm:mx-10 m-4">
      <h1>Título</h1>
      <p className="break-word font-extralight">
        ...
        lacus lorem varius purus. Curabitur eu amet. Duis ultricies pharetra
        ...
        magna. Sed laoreet aliquam leo. Ut tellus dolor, dapibus eget, elementum
        vel, cursus eleifend, elit. Aenean auctor wisi et urna. Aliquam erat
        volutpat. Duis ac turpis. Integer rutrum ante eu lacus. Vestibulum
        libero nisl, porta vel, scelerisque eget, malesuada at, neque. Vivamus
        eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros.
        Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere
        cubilia Curae; Suspendisse sollicitudin velit sed leo. Ut pharetra augue
        nec augue. Nam elit magna, hendrerit sit amet, tincidunt ac, viverra
        sed, nulla. Donec porta diam eu massa. Quisque diam lorem, interdum
